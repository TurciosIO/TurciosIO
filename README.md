...
<!--* 🌱 **Expanding Horizons:** I am currently expanding my skill set into **Full Stack Web Development** to build real-time visualization tools for embedded systems. -->
...
* Memory Management & Real-Time Constraints.

---

<!--
### 🚀 The "Metal2Pixel" Journey (Learning Path)
*Documenting my transition from low-level code to high-level web interfaces.*

I am building side projects to bridge the gap between hardware and the cloud. My goal is to create **E2E solutions** where embedded devices communicate seamlessly with modern dashboards.
...
I share my engineering journey and tutorials under the brand **TurciOS / Metal2Pixel**.

* **Goal:** To document the process of becoming a Full-Stack Engineer from an Embedded perspective.
* **Coming Soon:** Technical content on YouTube & Twitch.
